...
from ..utils_api import get_combined_auth_dependency, get_admin_auth_dependency
...
def create_graph_routes(rag, api_key: Optional[str] = None):
    ...
    @router.post("/graph/entity/edit", dependencies=[Depends(admin_auth)])
    ...
    @router.post("/graph/relation/edit", dependencies=[Depends(admin_auth)])
    ...
    @router.post("/graph/entity/create", dependencies=[Depends(admin_auth)])
    ...
    @router.post("/graph/relation/create", dependencies=[Depends(admin_auth)])
    ...
    @router.post("/graph/entities/merge", dependencies=[Depends(admin_auth)])
