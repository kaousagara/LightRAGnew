...
class QueryParam:
    ...
    user_accreditation_level: int = int(os.getenv("DEFAULT_USER_ACCREDITATION_LEVEL", "999"))
    """Accreditation level of the user making the query.
    Only documents, chunks, entities and relations with accreditation_level <= user_accreditation_level
    will be retrieved. Higher numbers indicate higher clearance levels.
    Default is 999 (access to all documents).
    """
...
class DocProcessingStatus:
    ...
    accreditation_level: int | None = None
    """Security clearance level for document (0 = public, higher = restricted)"""
    service: str | None = None
    """Service/department tag (DOCT, DRI, DT, DREC, DAF, CABINET, DAP)"""
