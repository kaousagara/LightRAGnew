...
# Entity merging configuration defaults
DEFAULT_ENTITY_MERGE_SIMILARITY_THRESHOLD = 0.85  # Threshold for semantic similarity when merging entities
DEFAULT_ENABLE_ENTITY_MERGE_VERIFICATION = True  # Enable verification before merging entities with same name
DEFAULT_ENTITY_CONTEXT_SIMILARITY_WEIGHT = 0.3  # Weight for context similarity (file_path, source_id) vs description similarity
