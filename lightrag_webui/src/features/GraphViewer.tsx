...
const GraphEvents = () => {
  ...
  useEffect(() => {
    ...
    registerEvents({
      clickNode: (e) => {
        const mouseEvent = e.event.original as MouseEvent
        if (mouseEvent.ctrlKey || mouseEvent.metaKey) {
          useGraphStore.getState().toggleNodeSelection(e.node)
        } else {
      ...
      clickEdge: (e) => {
        const mouseEvent = e.event.original as MouseEvent
        if (mouseEvent.ctrlKey || mouseEvent.metaKey) {
          useGraphStore.getState().toggleEdgeSelection(e.edge)
        } else {
          useGraphStore.getState().setSelectedEdge(e.edge)
        }
      },
      downNode: (e) => {
        const mouseEvent = e.event.original as MouseEvent
